...
def main():
    ...
    parser.add_argument('--model_url', default='https://drive.google.com/u/0/uc?id=1hdgO97az-xxhCXXKwYADZXjVXKb90fMC&export=download', help='Fetch a StyleGAN model to train on from this URL') # karras2019stylegan-ffhq-1024x1024.pkl
